      ...
      <main className="main">
        ...
        <div className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <button className={styles.headerButton}>Pesan Sekarang<span><img className={styles.arrow} src="/assets/HomeAsset/arrow.svg" /></span></button>
          </div>
        </div>
        ...
        <div className={styles.layananContainer}>
          ...
          <div className={styles.blogContainer}>
            <div className={styles.blogTitle}>
              ...
              <button className={styles.blogTitleRight}>See All<span><img className={styles.arrow} src="/assets/HomeAsset/arrow.svg" /></span></button>
            </div>
            <div className={styles.blog}>
              ...
              <div className={styles.blogRightContainer}>
                  <div data-aos="fade-up" data-aos-once="false" data-aos-anchor-placement="top-bottom" data-aos-delay="300" data-aos-duration="1000" data-aos-offset="200" className={styles.blogRight}>
                    <div className={styles.blogRightImg}><img src="/assets/HomeAsset/carSample.png" alt="" /></div>
